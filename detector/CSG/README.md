...
All Geant4 [CSG][], except paraboloid, can be implemented using [pure text with simple syntax](..). Shapes demonstrated in this repository include [box](box), [cone section](cons), [ellipsoid](ellipsoid), [generic trapezoid](trap11), [hyperbolic tube profile](hype), [parallelepiped](para), [polycone](polycone), [right angular wedge](trap4), [sphere](sphere), [trapezoid](trd), [torus](torus), [tub section](tubs), [twisted box](twistedBox).
