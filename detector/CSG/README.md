...
All Geant4 [CSG][], except paraboloid, can be implemented using [pure text with simple syntax](..). Shapes demonstrated in this repository include [box](box), [tub section](tubs), [sphere](sphere), [cone section](cons), [ellipsoid](ellipsoid), [hyperbolic tube profile](hype), [parallelepiped](para), [polycone](polycone), [torus](torus), [twisted box](twistedBox).
