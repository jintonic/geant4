...
All Geant4 [CSG][], except paraboloid, can be implemented using [pure text with simple syntax](..). Shapes demonstrated in this repository include [box](box), [tubs](tubs), [sphere](sphere), [cone](cons), [torus](torus), [twisted box](twistedBox).
